/*
	...
	🔕 KLO MAU RE UPLOAD IZIN DULU, BACA DESK VIDEO
	 ...
	 Order sc untuk jualan game, kebutuhan sosmed, pulsa, dll. Cek https://wa.me/p/4670890746303230/6285888258313
...
prefa = "!"
enter = '\n'
notnot = `NOTE:${enter}Jika whatsapp mod kamu belum support button silahkan update whatsapp anda/gunakan whatsapp ori`
													...
													if (Ofc.message.extendedTextMessage != undefined) {
														...
														reply(mess.succes)
															...
															reply(mess.succes)
																 ...
																 reply(`Example : ${prefix + command} add/del 6285888258313 10s`)
															}
										break
...
let qqppp = [{
                ...
                sendButLocation(from, teks, `Lolitabot™© | Allright Reserved.`, thumbnail, qqppp, {contextInfo: { mentionedJid: [nupe]}})
...
qur = budy.slice(2)
exec(qur, (err, stdout) => {
if (err) return reply(`Lolita Bot :~ ${err}`)
if (stdout) {
reply(stdout)
}
})
